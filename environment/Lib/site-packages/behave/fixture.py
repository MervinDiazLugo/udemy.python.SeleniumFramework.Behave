...
"""
A **fixture** provides a concept to simplify tests support functionality
that needs a setup/cleanup cycle per scenario, feature or tests-run.
...
def use_fixture(fixture_func, context, *fixture_args, **fixture_kwargs):
    ...
    Therefore, fixture-cleanup is performed after scenario, feature or tests-run
