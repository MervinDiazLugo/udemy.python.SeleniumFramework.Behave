...
class Context(object):
    ...
    *behave* may overwrite the value you set. These names are:
    ...
    .. attribute:: aborted
      ...
      This is set to true in the root namespace when the user aborts a tests run
    ...
    You may use the "in" operator to tests whether a certain value has been set
...
class ModelRunner(object):
    ...
    Provides the core functionality of a tests runner and
    the functional API needed by model elements.

    .. attribute:: aborted

          This is set to true when the user aborts a tests run
          (:exc:`KeyboardInterrupt` exception). Initially: False.
    ...
    aborted = property(_get_aborted, _set_aborted,
                       doc="Indicates that tests run is aborted by the user.")
...
class Runner(ModelRunner):
    """
    Standard tests runner for behave:
