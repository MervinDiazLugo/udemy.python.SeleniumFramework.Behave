...
class Feature(TagAndStatusStatement, Replayable):
    ...
    .. attribute:: duration
       ...
       The time, in seconds, that it took to tests this feature. If read before
    ...
    def reset(self):
        """Reset to clean state before a tests run."""
...
class Scenario(TagAndStatusStatement, Replayable):
    ...
    .. attribute:: duration
       ...
       The time, in seconds, that it took to tests this scenario. If read before
...
class ScenarioOutline(Scenario):
    ...
    .. attribute:: duration
       ...
       The time, in seconds, that it took to tests the scenarios of this
    ...
    def reset(self):
        """Reset runtime temporary data like before a tests run."""
...
class Step(BasicStatement, Replayable):
    ...
    .. attribute:: duration
       ...
       The time, in seconds, that it took to tests this step. If read before the
...
def reset_model(model_elements):
    """Reset the tests run information stored in model elements.
