...
of the last tests run. It writes a text file with the file locations of
the failing scenarios, like:

    # -- file:rerun.features
    # RERUN: Failing scenarios during last tests run.
...
class RerunFormatter(Formatter):
    ...
    during the last tests run. This output can be used to rerun the tests
    ...
    def report_scenario_failures(self):
        ...
        # -- SECTION: Banner
        message = u"# -- RERUN: %d failing scenarios during last tests run.\n"
