...
options = [
    ...
    (("--stage",),
     dict(help="""Defines the current tests stage.
                  The tests stage name is used as name prefix for the environment
...
class Configuration(object):
    ...
    def setup_stage(self, stage=None):
        """Setup the tests stage that selects a different set of
        steps and environment implementations.

        :param stage:   Name of current tests stage (as string or None).
