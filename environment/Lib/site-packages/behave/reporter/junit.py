...
class JUnitReporter(Reporter):
    """Generates JUnit-like XML tests report for behave.
    """
    # -- XML REPORT:
    ...
    def describe_scenario(self, scenario):
        """Describe the scenario and the tests status.
    ...
    def _process_scenario(self, scenario, report):
        ...
        # Create stdout section for each tests case
        ...
        # Create stderr section for each tests case
