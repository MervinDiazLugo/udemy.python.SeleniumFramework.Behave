...
class _TestInfo(object):
    ...
    def test_finished(self):
        """Save info that can only be calculated once a tests has run.
        """
        self.elapsed_time = \
    ...
    def get_error_info(self):
        """
        Return a text representation of an exception thrown by a tests
        method.
        """
...
class _XMLTestResult(_TextTestResult):
    """
    A tests result class that can express tests results in a XML report.
    ...
    def _prepare_callback(self, test_info, target_list, verbose_str,
        ...
        def callback():
            """Prints the tests method outcome to the stream, as well as
            the elapsed time.
            """
    ...
    def startTest(self, test):
        """
        Called before execute each tests method.
        """
        ...
        try:
            ...
            # issue #188, #189, some frameworks can make tests method opaque.
            pass
    ...
    def stopTest(self, test):
        """
        Called after execute each tests method.
        """
    ...
    def addSuccess(self, test):
        """
        Called when a tests executes successfully.
        """
        self._save_output_data()
    ...
    def addFailure(self, test, err):
        """
        Called when a tests method fails.
        """
        self._save_output_data()
    ...
    def addError(self, test, err):
        """
        Called when a tests method raises an error.
        """
        self._save_output_data()
        testinfo = self.infoclass(
    ...
    def addSkip(self, test, reason):
        """
        Called when a tests method was skipped.
        """
        self._save_output_data()
        testinfo = self.infoclass(
    ...
    def addUnexpectedSuccess(self, test):
        ...
        testinfo.test_exception_message = ('Unexpected success: This tests was marked as expected failure but passed, '
                                           'please review it')
    ...
    def _get_info_by_testcase(self):
        """
        Organizes tests results by TestCase module. This information is
        ...
        for tests in (self.successes, self.failures, self.errors,
            ...
            for test_info in tests:
                if isinstance(test_info, tuple):
                    # This is a skipped, error or a failure tests case
    ...
    def _exc_info_to_string(self, err, test):
        ...
        # Skip tests runner traceback levels
